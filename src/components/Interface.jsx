...
export const Interface = () => {
    return (
        <div className="relative flex flex-col w-full text-white z-[999999] overflow-x-hidden">
            {/* Section 1: Hero */}
            <Section align="right">
                <div className="overflow-hidden mt-32 mr-8 md:mr-16">
                    <motion.h1
                        initial={{ y: "100%" }}
                        whileInView={{ y: 0 }}
                ...
                <div className="overflow-hidden mr-8 md:mr-16">
                    <motion.h2
                        initial={{ y: "100%" }}
                        whileInView={{ y: 0 }}
            ...
            <Section align="left">
                ...
                >
                    ...
                    <p className="text-white text-sm md:text-base font-mono uppercase tracking-[0.2em] max-w-sm mr-auto">
            ...
            <Section align="right">
                ...
                >
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-end gap-4 text-white font-mono text-xs uppercase tracking-widest">
                ...
                >
                    ...
                    <div className="flex gap-8 justify-start">
                        <div className="text-center">
                            ...
                            <div className="text-[10px] text-white uppercase tracking-widest mt-1">Monitoring</div>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl md:text-5xl font-black text-orange-500">98%</div>
                            <div className="text-[10px] text-white uppercase tracking-widest mt-1">Uptime</div>
                        </div>
                    </div>
                </motion.div>
            </Section>
            ...
            <Section align="right">
                ...
                >
                    ...
                    <p className="text-white text-sm md:text-base font-mono uppercase tracking-[0.2em] max-w-md ml-auto">
            ...
            <Section align="left">
                ...
                >
                    ...
                    <div className="space-y-2 text-left mr-auto max-w-xs">
                ...
                >
                    ...
                    <div className="flex gap-6 justify-end">
                        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                            ...
                            <div className="text-[10px] text-white uppercase">AC Charger</div>
                        </div>
                        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                            <div className="text-2xl font-black text-green-500">150kW</div>
                            <div className="text-[10px] text-white uppercase">DC Fast</div>
                        </div>
                    </div>
                </motion.div>
            </Section>
            ...
            <Section align="left">
                ...
                >
                    ...
                    <ul className="space-y-2 font-mono text-xs text-white uppercase tracking-widest text-left">
                        <li className="flex items-center justify-start gap-3"><span className="w-1.5 h-1.5 bg-red-500 rounded-full" /> 24/7 AI Video Analytics</li>
                        <li className="flex items-center justify-start gap-3"><span className="w-1.5 h-1.5 bg-red-500 rounded-full" /> Intrusion Detection</li>
                        <li className="flex items-center justify-start gap-3"><span className="w-1.5 h-1.5 bg-red-500 rounded-full" /> Digital Valet Retrieval</li>
                    </ul>
                </motion.div>
            </Section>
            ...
            <Section align="right">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-3 justify-end">
                        <span className="bg-white/10 px-3 py-1 rounded-full text-xs font-mono text-white">UPI</span>
                        <span className="bg-white/10 px-3 py-1 rounded-full text-xs font-mono text-white">FASTag</span>
                        <span className="bg-white/10 px-3 py-1 rounded-full text-xs font-mono text-white">Card</span>
                        <span className="bg-white/10 px-3 py-1 rounded-full text-xs font-mono text-white">Wallet</span>
                    </div>
                </motion.div>
            </Section>
