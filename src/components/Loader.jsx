...
export const Loader = () => {
    ...
    return (
        <motion.div
            initial={{ opacity: 1 }}
            animate={controls}
            className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#09090b] transition-opacity duration-1000 ${!active ? "pointer-events-none" : ""
                }`}
        >
            <div className="relative flex flex-col items-center overflow-hidden">
                ...
                <motion.div
                    ...
                    className="h-[1px] bg-gradient-to-r from-transparent via-red-600 to-transparent mb-8"
                />
