        ...
        <div className="bg-[#09090b] min-h-screen text-white pt-32">
            <main className="max-w-7xl mx-auto px-6 md:px-12 pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-48">
                    <div>
                        <h2 className="text-4xl md:text-5xl font-serif italic mb-6">Automation by Design, <br /><span className="text-blue-500">Not by Exception</span></h2>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-zinc-900/40 p-6 rounded-xl border border-white/5 flex items-center gap-4 group hover:border-blue-500/30 transition-colors"
                            >
                ...
                <div className="mb-48">
                    <h2 className="text-3xl md:text-5xl font-serif italic mb-16 text-center">Three-Tier Framework for <span className="text-blue-500">Zero Downtime</span></h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-zinc-900/30 p-8 rounded-[2rem] border border-white/5 relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500">
                                ...
                                <h3 className="text-2xl font-serif italic mb-4">{tier.name}</h3>
                ...
                <div className="mb-48 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div>
                        <h2 className="text-4xl md:text-5xl font-serif italic mb-8">Inside the ANPR Engine</h2>
                        <p className="text-zinc-400 mb-12 text-lg">Cameras That Don’t Just See — They Decide.</p>
                        <div className="space-y-8 relative">
                            {/* Connector Line */}
                            <div className="absolute left-[19px] top-4 bottom-4 w-[1px] bg-zinc-800" />
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center gap-6 relative z-10">
                                    <div className="w-10 h-10 rounded-full bg-[#09090b] border border-blue-500/50 flex items-center justify-center text-blue-500 text-xs font-bold shadow-[0_0_10px_rgba(37,99,235,0.2)]">
                                        {i + 1}
                                    </div>
                                    <p className="text-zinc-300 font-mono text-sm uppercase tracking-wider">{step}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    {/* Visual representation */}
                    <div className="aspect-square bg-zinc-900 rounded-[3rem] border border-white/10 relative overflow-hidden flex items-center justify-center">
                        ...
                        <div className="border border-white/20 p-8 rounded-xl bg-white/5 backdrop-blur-md">
                            <div className="font-mono text-2xl tracking-[0.2em] text-white">HR 26 DQ 5555</div>
                            <div className="mt-4 flex justify-between items-center text-[10px] font-mono uppercase text-green-400/80">
                ...
                <div className="mb-48 grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="bg-zinc-900/30 p-12 rounded-[3rem] border border-white/5">
                        <h3 className="text-3xl font-serif italic mb-6">Every Spot Knows Its Status</h3>
                        <ul className="space-y-4 mb-8">
                            <li className="text-zinc-400">✓ Detects vehicle presence</li>
                            <li className="text-zinc-400">✓ Updates occupancy in real time</li>
                            <li className="text-zinc-400">✓ Feeds dashboards, displays, and apps</li>
                        </ul>
                    ...
                    <div className="bg-zinc-900/30 p-12 rounded-[3rem] border border-white/5">
                        <h3 className="text-3xl font-serif italic mb-6">No Circling. No Guessing.</h3>
                        <p className="text-zinc-500 mb-8">LED vacancy displays, zone indicators, and in-app navigation working in harmony.</p>
                        <div className="bg-[#0f172a] p-6 rounded-2xl border border-white/5 flex justify-between items-center">
                            <span className="text-zinc-400 font-mono text-xs uppercase tracking-widest">Zone A Level 2</span>
                            <span className="text-green-400 font-mono text-4xl font-bold">14 <span className="text-xs font-normal text-zinc-600 align-middle">SPOTS</span></span>
                        </div>
                    </div>
                </div>

                {/* 2.7 Centralized Dashboards */}
                <div className="mb-48 bg-gradient-to-br from-zinc-900 to-black p-12 md:p-24 rounded-[3rem] border border-white/5 relative overflow-hidden">
                    <div className="relative z-10 text-center max-w-4xl mx-auto">
                        <span className="text-blue-500 font-mono text-xs tracking-widest uppercase mb-4 block">Total Visibility</span>
                        <h2 className="text-4xl md:text-6xl font-serif italic mb-12">Real-Time Visibility Across Every Site</h2>
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
                            {["Occupancy", "Entry Logs", "Revenue", "Health", "Violations"].map((metric, i) => (
                                <div key={i} className="flex flex-col items-center gap-3">
                                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse shadow-[0_0_8px_#22c55e]" />
                                    <span className="text-zinc-400 font-mono text-xs uppercase tracking-widest">{metric}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="mb-48 text-center">
                    <h2 className="text-3xl md:text-5xl font-serif italic mb-12">Frictionless Finance</h2>
                    <div className="flex flex-wrap justify-center gap-8">
                        {["FASTag", "UPI", "Credit Cards", "Debit Cards"].map((pay, i) => (
                            <div key={i} className="bg-white/5 px-8 py-4 rounded-full border border-white/10 text-zinc-300 font-mono text-sm uppercase tracking-widest hover:bg-white/10 hover:border-blue-500/50 transition-all">
                                {pay}
                            </div>
                        ))}
                    </div>
                    <p className="mt-8 text-zinc-500 font-light">Zero cash handling. Faster exits. Complete audit trails.</p>
                </div>

                {/* 2.9 Security */}
                <div className="mb-48 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-4xl md:text-5xl font-serif italic mb-8">Parking That Prevents Incidents</h2>
                        <p className="text-zinc-400 mb-8 max-w-md">AI analyzes live feeds, flags anomalies, and generates instant alerts.</p>
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-zinc-950 border border-red-500/20 rounded-2xl p-2 relative z-10">
                            {/* Mock Security Feed Interface */}
                            <div className="aspect-video bg-zinc-900 rounded-xl relative overflow-hidden flex items-center justify-center">
                                <span className="text-zinc-700 font-mono uppercase tracking-widest text-xs">Video Feed Inactive</span>
                ...
                <div className="mb-24 border-t border-white/5 pt-24 text-center">
                    <h2 className="text-4xl md:text-6xl font-serif italic mb-6">Built for Scale</h2>
                    <p className="text-zinc-500 text-xl font-light mb-12">From a single site to city-wide deployments.</p>
