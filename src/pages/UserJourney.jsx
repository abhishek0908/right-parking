...
const DiagramNode = ({ name, icon: Icon, highlight, className = "" }) => (
    <div className={`flex flex-col items-center gap-4 ${className}`}>
        <div className={`w-20 h-20 rounded-full flex items-center justify-center relative ${highlight ? 'bg-[#7c3aed]/20 border-[3px] border-[#7c3aed]' : 'bg-[#1e1b4b]/30 border border-zinc-700'} transition-all hover:scale-110 group`}>
            {Icon && <Icon size={32} className={`${highlight ? 'text-white' : 'text-[#7c3aed]'} group-hover:scale-110 transition-transform`} strokeWidth={1.5} />}
            {highlight && <div className="absolute inset-0 rounded-full animate-pulse bg-purple-500/20" />}
        </div>
        <span className="text-[10px] text-zinc-500 font-mono text-center uppercase tracking-widest leading-tight max-w-[100px]">{name}</span>
    </div>
);

const SlideHeader = ({ title, subtitle, icon: Icon }) => (
    <div className="absolute top-28 left-16 right-16 flex justify-between items-start z-30 pointer-events-none">
        <div className="flex gap-10">
            <div className="flex items-start gap-6">
                ...
                <div className="flex flex-col">
                    <h2 className="text-4xl font-sans font-light text-white tracking-tight leading-none opacity-80">
                        {title}
                    </h2>
                    <p className="text-4xl font-sans font-bold text-white tracking-tight mt-1">
                        {subtitle}
                    </p>
                </div>
            </div>
...
const SlideFrame = ({ children }) => (
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden pt-20 px-12 md:px-20">
            ...
            <main className="w-full">
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always relative overflow-hidden">
                    ...
                    <div className="relative h-full w-full flex flex-col items-center justify-center slide-content px-12 pt-20">
                        ...
                        >
                            <h1 className="text-7xl md:text-[12rem] font-display font-black tracking-tighter leading-none text-white italic">
                                USER<br />
                                <span className="text-blue-500 not-italic tracking-normal px-8 py-2 bg-blue-500/10 rounded-3xl border border-blue-500/20">JOURNEY</span>
                            </h1>
                            <p className="text-zinc-400 font-mono text-sm tracking-[0.5em] uppercase mt-12 opacity-60">
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative">
                    <SlideFrame>
                        ...
                        <div className="max-w-[110rem] w-full slide-content relative h-[70%] flex items-center justify-center pt-20">
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative">
                    <SlideFrame>
                        ...
                        <div className="max-w-7xl w-full slide-content relative h-[60%] mt-20">
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative">
                    <SlideFrame>
                        <div className="absolute top-28 left-16 z-30">
                            <span className="px-4 py-1.5 bg-[#4c1d95]/50 border border-[#7c3aed]/30 text-[#a78bfa] text-xl font-bold rounded-lg mb-8 inline-block">
                                Fastag Entry System
                            </span>
                        </div>

                        <div className="max-w-[110rem] w-full slide-content grid grid-cols-1 md:grid-cols-12 gap-12 mt-32 px-16 h-[75%] items-center">
                            {/* Left Side: Features */}
                            <div className="md:col-span-4 flex flex-col gap-6">
                                {[
                                    ...
                                    <div key={idx} className="p-8 bg-[#111116] border border-zinc-800/80 rounded-[2rem] flex items-center gap-10 hover:border-blue-500/50 transition-all group">
                                        <div className="w-16 h-16 flex-shrink-0 bg-[#06070d] border border-zinc-800 rounded-xl flex items-center justify-center text-zinc-500 group-hover:text-blue-500 group-hover:border-blue-500/50 transition-colors">
                                            {typeof item.icon === 'string' ? (
                                                <span className="text-xl font-black font-mono tracking-tighter">{item.icon}</span>
                                            ) : (
                                                <item.icon size={32} strokeWidth={1} />
                                            )}
                                        </div>
                                        <p className="text-zinc-300 text-lg leading-snug font-normal opacity-90">{item.text}</p>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="md:col-span-8 h-full">
                                <div className="bg-[#111116] border border-zinc-800/80 rounded-[3rem] p-12 h-full relative overflow-hidden flex flex-col justify-center">
                                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,_rgba(76,29,149,0.05)_0%,_transparent_50%)]" />

                                    <div className="grid grid-cols-4 gap-y-16 gap-x-8 relative z-10">
                                        {/* Top Row */}
                                        ...
                                        <div className="flex flex-col items-center gap-3">
                                            <div className="w-20 h-32 bg-zinc-900 border border-zinc-700/50 rounded-2xl flex flex-col items-center justify-center gap-4 text-zinc-500 relative">
                                                <div className="w-12 h-0.5 bg-zinc-700 rounded-full" />
                                                <div className="w-12 h-0.5 bg-zinc-700 rounded-full" />
                                                <div className="w-12 h-0.5 bg-zinc-700 rounded-full" />
                                                <span className="text-[7px] uppercase font-mono tracking-tighter px-2 text-center absolute -bottom-8 w-24 left-1/2 -translate-x-1/2 text-zinc-600 font-bold leading-tight">SKIDATA Local PMS Server</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-span-2 flex justify-center py-4">
                                            <div className="flex flex-col items-center justify-center px-8 py-4 bg-white rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                                                <span className="text-[#06070d] font-black text-2xl tracking-tighter italic">NPCI</span>
                                                <div className="h-[2px] w-full bg-[#1c3e98] my-1" />
                                                <span className="text-[6px] text-[#06070d] uppercase font-bold text-center leading-tight">National Payments Corporation of India</span>
                                            </div>
                                        </div>
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative">
                    <SlideFrame>
                        ...
                        <div className="max-w-[110rem] w-full slide-content grid grid-cols-1 md:grid-cols-12 gap-12 mt-32 px-16 h-[75%] items-center">
                            {/* Left Side: Features */}
                            <div className="md:col-span-4 flex flex-col gap-6 p-12 bg-[#111116] border border-zinc-800/80 rounded-[3rem]">
                                <ul className="space-y-8">
                                    {[
                                        ...
                                        <li key={i} className="flex gap-6 text-zinc-300 text-lg leading-relaxed font-normal opacity-90">
                                            <div className="w-2.5 h-2.5 rounded-full bg-blue-500 mt-3 flex-shrink-0" />
                                            {point}
                                        </li>
                                    ))}
                                </ul>
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative overflow-hidden">
                    <SlideFrame>
                        ...
                        <div className="max-w-[100rem] w-full slide-content relative h-[70%] mt-24">
                            ...
                            <div className="grid grid-cols-12 gap-8 items-center h-full relative z-20">
                                <div className="col-span-4 flex flex-col items-center gap-8">
                                    <div className="p-8 bg-white rounded-[2.5rem] shadow-2xl scale-110">
                                        <QrCode size={180} className="text-[#06070d]" strokeWidth={1.5} />
                                    </div>
                                    <p className="text-zinc-500 font-mono text-xs tracking-widest uppercase">Scan to Request</p>
                                </div>

                                <div className="col-span-4 flex flex-col items-center">
                                    <div className="w-[300px] h-[600px] bg-[#0c0c14] border-[8px] border-zinc-800 rounded-[3rem] p-6 shadow-2xl relative">
                                        <div className="w-24 h-6 bg-zinc-800 rounded-full mx-auto mb-8" />
                                        <div className="flex flex-col items-center text-center">
                                            <img src="/logo.svg" alt="Logo" className="h-12 w-auto mb-12 opacity-80" />
                                            <span className="text-zinc-400 text-sm mb-2">Welcome, Guest</span>
                                            <span className="text-white text-xl font-bold mb-12 uppercase tracking-tighter">KA07N5556</span>

                                            <button className="w-full py-5 bg-blue-600 rounded-2xl text-white font-bold text-lg shadow-[0_10px_30px_rgba(37,99,235,0.4)] hover:bg-blue-500 transition-all uppercase tracking-tight">
                                                Request My Car
                                            </button>

                                            <div className="mt-16 w-full px-4 text-left">
                                                <div className="h-px bg-zinc-800 w-full mb-6" />
                                                <span className="text-[10px] text-zinc-500 uppercase tracking-widest">Valet PIN</span>
                                                <div className="text-blue-500 font-mono text-2xl mt-1 tracking-widest">01-1234</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div className="col-span-4 flex flex-col gap-6 pl-12">
                                    <div className="w-20 h-20 bg-blue-600/10 rounded-full flex items-center justify-center text-blue-500 border border-blue-500/20">
                                        <Smartphone size={32} />
                                    </div>
                                    <h2 className="text-5xl font-display font-black text-white leading-tight uppercase italic underline decoration-blue-500/30 underline-offset-8">
                                        Tap <br />
                                        <span className="text-zinc-500">to</span> <br />
                                        Retrieve
                                    </h2>
                ...
                <section className="journey-panel h-screen w-full snap-start snap-always bg-[#06070d] relative">
                    <SlideFrame>
                        ...
                        <div className="max-w-[105rem] w-full slide-content grid grid-cols-2 md:grid-cols-3 gap-y-16 gap-x-20 relative z-20 px-24 mt-32">
                            {[
                                ...
                                return (
                                    <div key={idx} className="flex gap-8 group">
                                        <div className="relative flex-shrink-0">
                                            <div className="w-24 h-24 rounded-full bg-[#0a0b14] border-[5px] border-purple-900 flex items-center justify-center relative overflow-hidden group-hover:border-purple-500 transition-all duration-500 shadow-[0_0_20px_rgba(168,85,247,0.1)] group-hover:shadow-purple-500/30">
                                                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent" />
                                                <Icon size={40} className="text-white relative z-10" strokeWidth={1.2} />
                                            </div>
                                        </div>
                                        <div className="flex flex-col justify-center">
                                            <h4 className="text-white font-bold text-xl mb-3 leading-tight tracking-tight">{item.name}</h4>
                                            <p className="text-zinc-500 text-[14px] font-normal leading-snug max-w-[320px]">{item.desc}</p>
                                        </div>
                                    </div>
                                );
                            })}
